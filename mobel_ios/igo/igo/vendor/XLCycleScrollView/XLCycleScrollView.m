...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _pageControl.coreSelectedColor = [UIColor colorWithRed:1 green:0.32 blue:0.17 alpha:1];
...
{
    _pageControl.coreNormalColor = normalColor;
    _pageControl.coreSelectedColor = selectedColor;
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)aScrollView {
    ...
    if ([_delegate respondsToSelector:@selector(XLCycleViewDidEndDecelerating:atIndex:)]) {
        [_delegate XLCycleViewDidEndDecelerating:self atIndex:_curPage];
    }
}
