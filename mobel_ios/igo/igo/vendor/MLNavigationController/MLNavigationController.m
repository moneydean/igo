...
@property (strong, nonatomic) MLPanGestureRecognizer *recognizer;
...
- (void)viewDidLoad
{
    ...
    self.recognizer = [[MLPanGestureRecognizer alloc]initWithTarget:self action:@selector(paningGestureReceive:)];
